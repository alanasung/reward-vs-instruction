...
This note situates **Reward Seeking Versus Instruction Following Transfer** against the mentor-linked literature for
[Reward Seeking Versus Instruction Following Transfer](https://github.com/alanasung/reward-vs-instruction).

## Positioning

Compare how reward-seeking and instruction-following behaviors transfer across small task shifts.

The design hypothesis is: Compare how reward-seeking and instruction-following behaviors transfer across small task shifts.
