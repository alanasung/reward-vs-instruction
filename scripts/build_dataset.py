...
def _registered_builder(name: str):
    ...
    try:
        module = importlib.import_module("rewinst.data")
...
def main(argv: list[str] | None = None) -> int:
    ...
    from rewinst.configs.loader import load_config
    from rewinst.utils.run_manifest import utc_now_iso, write_json_atomic
    ...
    if builder is not None:
        ...
        source = f"rewinst.data.BUILDERS[{data.name!r}]"
        ...
        print(
            ...
            "src/rewinst/data/__init__.py under BUILDERS, or use data=synthetic "
