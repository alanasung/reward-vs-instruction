...
from rewinst.configs.loader import register_schema
...
def _load_stage_registry(package: str = "rewinst") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in rewinst.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from rewinst.configs.loader import config_to_dict, save_resolved_config
    from rewinst.models.device import get_device
    from rewinst.utils.logging import configure_logging
    from rewinst.utils.reproducibility import set_seed
    from rewinst.utils.run_manifest import create_run_dir, save_run_metadata
