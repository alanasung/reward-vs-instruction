"""Experiment stages for Reward Seeking Versus Instruction Following Transfer."""
...
from .rewinst._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Reward Seeking Versus Instruction Following Transfer", "claims_gated": True})
