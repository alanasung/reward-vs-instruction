import json
from rewinst.reporting.aggregate import aggregate_results, flatten_metrics
from rewinst.reporting.tables import write_tables
from rewinst.reporting.figures import write_caption, write_figures
